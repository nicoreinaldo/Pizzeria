 ...
 */
class Version20180114193751 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE Cliente CHANGE id_user id_fos INT NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE Cliente CHANGE id_fos id_user INT NOT NULL');
