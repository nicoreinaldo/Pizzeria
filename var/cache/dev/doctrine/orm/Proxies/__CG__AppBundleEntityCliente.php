...
class Cliente extends \AppBundle\Entity\Cliente implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Cliente' . "\0" . 'idcliente', '' . "\0" . 'AppBundle\\Entity\\Cliente' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Cliente' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Cliente' . "\0" . 'direccion'];
        }
