...
class Pedido extends \AppBundle\Entity\Pedido implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Pedido' . "\0" . 'idpedido', '' . "\0" . 'AppBundle\\Entity\\Pedido' . "\0" . 'idcliente', '' . "\0" . 'AppBundle\\Entity\\Pedido' . "\0" . 'idestadopedido', '' . "\0" . 'AppBundle\\Entity\\Pedido' . "\0" . 'fecha', '' . "\0" . 'AppBundle\\Entity\\Pedido' . "\0" . 'pizzapedido'];
        }
    ...
    public function setIdestadopedido($idestadopedido)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdestadopedido', [$idestadopedido]);

        return parent::setIdestadopedido($idestadopedido);
    }
    ...
    public function getIdestadopedido()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdestadopedido', []);

        return parent::getIdestadopedido();
    }
