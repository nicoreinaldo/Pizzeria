...
class Pedido extends \AppBundle\Entity\Pedido implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Pedido' . "\0" . 'idpedido', '' . "\0" . 'AppBundle\\Entity\\Pedido' . "\0" . 'fecha', '' . "\0" . 'AppBundle\\Entity\\Pedido' . "\0" . 'idcliente', '' . "\0" . 'AppBundle\\Entity\\Pedido' . "\0" . 'idestadopedido'];
        }
