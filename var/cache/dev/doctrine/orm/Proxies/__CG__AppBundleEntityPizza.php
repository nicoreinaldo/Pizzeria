...
class Pizza extends \AppBundle\Entity\Pizza implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Pizza' . "\0" . 'idpizza', '' . "\0" . 'AppBundle\\Entity\\Pizza' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Pizza' . "\0" . 'precio', '' . "\0" . 'AppBundle\\Entity\\Pizza' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Pizza' . "\0" . 'idtamanopizza'];
        }
